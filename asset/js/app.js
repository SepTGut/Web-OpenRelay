...
(function initNav() {
  ...
  function updateActiveNavLink() {
    ...
    sections.forEach(section => {
      const sectionTop = section.offsetTop - 80; // Account for nav height
    ...
    // If we're at the top of page, highlight the first link or home
    if (window.pageYOffset < 80) {
      currentSectionId = 'home'; // or could be empty for logo link
    }
    ...
    navLinks.forEach(link => {
      ...
      const isActive =
        ...
        (href === '#about' && currentSectionId === 'about') ||
        (href === '#features' && currentSectionId === 'features') ||
        (href === '#architecture' && currentSectionId === 'architecture') ||
        (href === '#team' && currentSectionId === 'team') ||
        (href === '#access' && currentSectionId === 'access');
